...
\begin{figure}[h]\centering\includegraphics[width=0.9\textwidth]{fig1_val_acc_all_arms.png}
...
\begin{figure}[h]\centering\includegraphics[width=\textwidth]{fig2_overlong_calls_tokens.png}
...
\begin{figure}[h]\centering\includegraphics[width=\textwidth]{fig3_thinking_stats.png}
...
\begin{figure}[h]\centering\includegraphics[width=\textwidth]{fig4_training_curves.png}
...
\begin{subfigure}[t]{0.58\textwidth}\includegraphics[width=\textwidth]{fig5_gain_over_base.png}\caption{Accuracy gain over the arm's own step-0 accuracy.}\end{subfigure}\hfill
\begin{subfigure}[t]{0.38\textwidth}\includegraphics[width=\textwidth]{fig6_task_agreement.png}\caption{Per-task agreement at step 100.}\end{subfigure}
